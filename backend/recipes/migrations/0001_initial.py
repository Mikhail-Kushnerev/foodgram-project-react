# Generated by Django 4.0.4 on 2022-04-28 22:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ManyToManyField(related_name='images', to='recipes.image_of_recipe')),
                ('ingredients', models.ManyToManyField(related_name='ingredient', to='recipes.ingredient')),
